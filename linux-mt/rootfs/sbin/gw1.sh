...
if [ ! -z "$2" ]; then
ipsec_add_ikekey_in_conf.sh psk $2 $3 $4 modp1024 $4 no
else
...
insmod /lib/modules/${KERNEL_VER}/kernel/drivers/net/cryptoDriver_eip97/crypto_eip97_k.ko
...
insmod /lib/modules/${KERNEL_VER}/kernel/drivers/net/cryptoDriver/crypto_k.ko
fi
