...
#define FOE_INFO_START_ADDR_TAIL(skb)  \
	((long)(skb->end - FOE_INFO_LEN))

#define FOE_TAG_PROTECT_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end) - FOE_INFO_LEN))->MAGIC_TAG_PROTECT)
#define FOE_ENTRY_NUM_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->foe_entry_num)
#define FOE_ALG_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->ALG)
#define FOE_AI_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->CRSN)
#define FOE_SP_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->SPORT)
#define FOE_MAGIC_TAG_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->IF)

#if defined(CONFIG_RA_HW_NAT_PPTP_L2TP)
#define FOE_SOURCE_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->SOURCE)
#define FOE_DEST_TAIL(skb)  \
	(((struct pdma_rx_desc_info4 *)((long)((skb)->end - FOE_INFO_LEN)))->DEST)
#endif
